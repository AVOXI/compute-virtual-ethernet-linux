...
struct gve_rx_alloc_rings_cfg {
	...
	struct gve_rx_queue_config *qcfg;
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(6,8,0))
#define GVE_PRIV_FLAGS_MASK (BIT(GVE_PRIV_FLAGS_REPORT_STATS) | BIT(GVE_PRIV_FLAGS_ENABLE_HEADER_SPLIT) | BIT(GVE_PRIV_FLAGS_ENABLE_STRICT_HEADER_SPLIT) | BIT(GVE_PRIV_FLAGS_ENABLE_MAX_RX_BUFFER_SIZE))
...
static inline u32 gve_get_rx_qpl_id(const struct gve_tx_queue_config *tx_cfg, int rx_qid)
{
